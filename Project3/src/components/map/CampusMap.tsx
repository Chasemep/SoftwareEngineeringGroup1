...
import { MapControlDock } from './MapControlDock'
      ...
      <section className="map-shell relative h-full w-full overflow-hidden rounded-panel border border-slate-300/70 shadow-panelLg">
        <div className="p-4">
          <ErrorState
            ...
            description="No Hammond feature data was loaded. This map expects local Hammond building, parking, and housing data."
          />
        </div>
      </section>
    )
  ...
  return (
    <section className="map-shell relative h-full w-full overflow-hidden rounded-panel border border-slate-300/75 shadow-panelLg">
      <MapContainer
        ...
        minZoom={hammondCampusConfig.minZoom}
        ...
        <div className="pointer-events-none absolute left-4 top-20 z-[500] max-w-xs">
          <div className="pointer-events-auto">
            <EmptyState
              ...
              description="Enable one or more categories to show Hammond campus locations."
            />
          </div>
        </div>
      ) : null}
